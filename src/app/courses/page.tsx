...
export default function CoursesPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#E2E2E0] py-20 px-8 selection:bg-[#861211]/20">
      ...
      <SlideIn direction="up" className="max-w-6xl mx-auto text-center mb-16 flex flex-col items-center">
      ...
      {loading ? (
        ...
        /* Responsive Grid */
        <StaggerContainer className="grid gap-10 sm:grid-cols-2 lg:grid-cols-3 max-w-6xl mx-auto">
          {courses.map((course, index) => (
            /* Note: Ensure CourseCard uses high-fidelity styling to match */
            <ScaleIn key={course._id} delay={index * 0.1}>
              <CourseCard
                title={course.title}
