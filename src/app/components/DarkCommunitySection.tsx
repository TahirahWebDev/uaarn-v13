    ...
    <div className="min-h-screen bg-[#E2E2E0] py-18 px-4 sm:px-6 lg:px-8 selection:bg-[#861211]/20">
      <div className="max-w-7xl mx-auto">
        ...
        <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          {/* Card 1: Developers */}
          <ScaleIn delay={0}>
            <div className="relative group overflow-hidden bg-[#0E2931] rounded-[2.5rem] p-10 text-[#E2E2E0] shadow-2xl transition-transform hover:-translate-y-2 duration-500 h-full">
          ...
          <ScaleIn delay={0.1}>
            <div className="relative group overflow-hidden bg-[#861211] rounded-[2.5rem] p-10 text-white shadow-2xl transition-transform hover:-translate-y-2 duration-500 h-full">
          ...
          {/* Card 3: LinkedIn */}
          <ScaleIn delay={0.2}>
            <div className="relative group overflow-hidden bg-[#12484C] rounded-[2.5rem] p-10 text-[#E2E2E0] shadow-2xl transition-transform hover:-translate-y-2 duration-500 h-full">
              {/* Layered Wave Effect */}
