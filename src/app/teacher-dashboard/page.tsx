...
export default function TeacherDashboard() {
  ...
  if (!isLoaded) {
    return (
      <section className="min-h-screen flex flex-col items-center justify-center bg-[#E2E2E0]">
        ...
        <p className="text-[10px] font-black uppercase tracking-[0.4em] text-[#0E2931]/40">Loading Command Center...</p>
      </section>
    );
  }
  ...
  return (
    <main className="min-h-screen bg-[#E2E2E0] flex items-center justify-center p-6 selection:bg-[#861211]/20 font-sans">
      ...
      <ScaleIn className="w-full max-w-7xl">
        <div className="bg-white rounded-[2.5rem] w-full overflow-hidden flex flex-col md:flex-row min-h-[750px]">
