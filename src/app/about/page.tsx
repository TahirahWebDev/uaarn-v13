...
export default function AboutPage() {
  return (
    ...
    <div className="bg-[#E2E2E0] text-[#0E2931] px-6 py-10 flex flex-col items-center w-full relative overflow-hidden selection:bg-[#861211]/20 font-sans">
      ...
      <FadeIn className="max-w-4xl text-center space-y-10 pt-20 pb-24">
      ...
      <StaggerContainer className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-3 gap-6 mb-40 relative z-10">
        <ScaleIn delay={0}>
          <PillarCard
            icon={<Target size={24} />}
            title="Precision"
      ...
      <SlideIn direction="up" className="w-full max-w-4xl">
        <div className="bg-[#0E2931] rounded-[3rem] p-12 md:p-20 text-center relative overflow-hidden mb-40 shadow-2xl">
      ...
      <div className="mt-20 w-full max-w-6xl text-center pb-20">
        ...
        <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-12">
          ...
          <ScaleIn delay={0} className="h-full">
            <div className="group relative p-10 rounded-[2.5rem] bg-white border border-[#0E2931]/5 shadow-sm hover:shadow-2xl hover:shadow-[#2B7574]/10 transition-all duration-500 flex flex-col items-center h-full">
...
function PillarCard({ icon, title, desc }: { icon: React.ReactNode, title: string, desc: string }) {
  return (
    <div className="bg-white/50 border border-[#0E2931]/5 p-8 rounded-[2rem] hover:bg-white transition-all duration-300 shadow-sm hover:shadow-xl group h-full">
