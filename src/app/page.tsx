...
export default function HomePage() {
  return (
    <div className="bg-[#E2E2E0] text-[#0E2931] selection:bg-[#861211]/20 min-h-screen overflow-x-hidden">
      ...
      <section 
        className="relative overflow-hidden pt-32 pb-40 px-8 bg-cover bg-center bg-no-repeat"
        style={{ 
          backgroundImage: `linear-gradient(to right, rgba(226, 226, 224, 0) 30%, rgba(226, 226, 224, 0.4) 100%), url('/hero.jpeg')` 
        }}
      >
        ...
        <div className="max-w-5xl mx-auto flex flex-col items-center text-center relative z-10">
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border border-[#0E2931]/10 bg-white/80 backdrop-blur-sm shadow-sm text-[#0E2931] text-xs font-bold uppercase tracking-widest mb-10 animate-fade-in">
          ...
          <p className="mt-0 text-lg md:text-xl text-[#0E2931] max-w-2xl leading-relaxed font-semibold">
          ...
          <div className="mt-12 flex flex-wrap justify-center gap-6">
            ...
            <Link
              href="/about"
              className="px-10 py-4 border-2 border-[#0E2931] bg-white/20 backdrop-blur-md hover:bg-[#0E2931] hover:text-white text-[#0E2931] font-bold rounded-full transition-all text-sm uppercase tracking-widest"
            >
              The UAARN Method
            </Link>
          </div>
            ...
            <div className="flex flex-col items-center text-center mb-20">
              <div className="max-w-2xl">
                <h3 className="text-4xl md:text-5xl font-black text-[#0E2931] mb-4 uppercase tracking-tighter">
                  <TypewriterText text="Engineered for" loop={false} cursorColor="#861211" /> <span className="text-[#861211]">Excellence</span>
                </h3>
